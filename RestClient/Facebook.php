...
class Facebook implements RestClient {
     ...
     * @param $keywords array an array of search keywords
     * @return array of rendered Standard data for middleware to parse
     */
    public function get($id, $count, $keywords) {
        return $this->getFacebookPagePosts($this->getFacebookPageFeed($id, $count, $keywords));
    }
    ...
    private function renderSingleFacebookPagePost($postId) {
        ...
        curl_setopt($fetchMainPost, CURLOPT_URL,
            $this->facebookApiBaseUrl . $postId .
     ...
     * @return array of decoded JSON data
     */
    public function getFacebookPageFeed($id, $count, $keywords) {
